                ...
                <div class="bg-gray-100 rounded-lg shadow-lg p-4 mb-6">
                    <div class="flex justify-between items-center">
                        <h2 class="text-2xl font-bold underline">
                            <a href="{{ route('brands.edit', $brand) }}" class="text-blue-600 hover:text-blue-800">Редактировать</a>
                        </h2>
                    ...
                    <div class="bg-gray-100 rounded-lg shadow-lg p-4 mb-6">
                        <h2 class="text-xl font-semibold mb-2">Брэнд:</h2>
                        <h2 class="text-2xl font-bold underline"><a href="{{ route('brands.show', $brand) }}"> {{ $brand->name }}</a></h2>
                        ...
                        @if ($brand->cars->count() == 0)
                            <h2 class="text-xl font-semibold mb-2 mt-4">Нет машин</h2>
                        @endif

<div class="flex justify-evenly py-6 bg-blue-200">
    <a class="block text-2xl font-semibold uppercase text-gray-800 hover:text-yellow-700" href="{{ route('cars.index') }}">Автомобили</a>
    ...
    <a class="block text-2xl font-semibold uppercase text-gray-800 hover:text-yellow-700" href="{{ route('engines.index') }}">Двигатели</a>

        ...
        <div class="mt-10 sm:col-span-4">
            ...
            <div class="mt-2">
                <select id="type" name="type"
                    ...
                    <option @if (isset($engine) && $engine->type == 'benzine') selected @endif value="benzine"> Benzine </option>
                    <option @if (isset($engine) && $engine->type == 'diezel') selected @endif value="diezel"> Diezel </option>
                    <option @if (isset($engine) && $engine->type == 'electric') selected @endif value="electric"> Electric </option>
                </select>
            </div>
        </div>
